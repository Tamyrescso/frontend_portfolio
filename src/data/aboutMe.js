const aboutMeEn = (
  <>
      ...
      <p className='aboutText'>I'm passionate about tech and food!</p>
      <p className='aboutText'>I consider myself an eternal student, I love <b>planning and researching</b> solutions, addicted to to-do lists, <b>restless</b> by nature and extremely <b>focused</b> on my goals.</p>
      <p className='aboutText'>I'm carioca, I have a <b>degree in gastronomy</b> from UFRJ and I have been a buyer for over 3 years.</p>
...
const aboutMePt = (
  <>
      ...
      <p className='aboutText'>Sou uma pessoa apaixonada pela tecnologia e alimentação!</p>
      <p className='aboutText'>Me considero uma eterna estudante, amo <b>planejar e pesquisar</b> soluções, viciada em to-do lists, <b>inquieta</b> por natureza e extremamente <b>focada</b> em meus objetivos.</p>
      <p className='aboutText'>Sou carioca, <b>bacharel em gastronomia</b> pela UFRJ e fui compradora por mais de 3 anos.</p>
